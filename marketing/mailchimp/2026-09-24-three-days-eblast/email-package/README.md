# LBA E-Blast — 2026-09-24-three-days — Mailchimp Package
...
- The kick-off is Monday. The Summit is October 1st.
...
> Monday, 4:30 PM at the Tech Hub Center. Then the Summit on October 1st, and each one registers separately.

## Load it into Mailchimp

**Content → Email templates → Create Template → Code your own → Import Zip**, upload
`lba-eblast-2026-09-24-three-days.zip`, then start a campaign from the saved template. Mailchimp uploads the
