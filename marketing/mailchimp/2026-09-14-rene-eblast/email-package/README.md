# LBA E-Blast — 2026-09-14-rene — Mailchimp Package
...
- Ninety minutes tomorrow with René Redwood
- René Redwood is on Zoom tomorrow at 10 AM
- Tomorrow: Purpose, People, and AI

Preheader in this template:

> Session 1 of Building an AI-Ready Trusted Business starts tomorrow morning on Zoom, and there is still room.

## Load it into Mailchimp

**Content → Email templates → Create Template → Code your own → Import Zip**, upload
`lba-eblast-2026-09-14-rene.zip`, then start a campaign from the saved template. Mailchimp uploads the
