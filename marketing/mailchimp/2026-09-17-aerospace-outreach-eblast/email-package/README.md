# LBA E-Blast — 2026-09-17-aerospace-outreach — Mailchimp Package
...
- Wed, Sept 23: Winning the Aerospace Talent War
- Devin Hughes on aerospace talent, Sept 23
- An invitation we're passing along

Preheader in this template:

> Wednesday, September 23 at 5:30 PM at The Modern in Long Beach. Bestselling author Devin Hughes headlines.

## Load it into Mailchimp

**Content → Email templates → Create Template → Code your own → Import Zip**, upload
`lba-eblast-2026-09-17-aerospace-outreach.zip`, then start a campaign from the saved template. Mailchimp uploads the
