# LBA E-Blast — 2026-09-28-tonight — Mailchimp Package
...
- Long Beach Tech Week starts tonight
...
> The Kick-Off Reception is this evening at the new Tech Hub Center. The Summit follows on Thursday.

## Load it into Mailchimp

**Content → Email templates → Create Template → Code your own → Import Zip**, upload
`lba-eblast-2026-09-28-tonight.zip`, then start a campaign from the saved template. Mailchimp uploads the
