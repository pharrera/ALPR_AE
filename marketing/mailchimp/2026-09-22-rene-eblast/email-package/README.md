# LBA E-Blast — 2026-09-22-rene — Mailchimp Package
...
- Tomorrow: people, AI and workforce capacity
- René Redwood is on Zoom tomorrow at 11
- Good for Business: tomorrow, 11 to 1

Preheader in this template:

> Good for Business: Investing in People and AI as Workforce Capacity. Wednesday, 11:00 to 1:00 on Zoom.

## Load it into Mailchimp

**Content → Email templates → Create Template → Code your own → Import Zip**, upload
`lba-eblast-2026-09-22-rene.zip`, then start a campaign from the saved template. Mailchimp uploads the
