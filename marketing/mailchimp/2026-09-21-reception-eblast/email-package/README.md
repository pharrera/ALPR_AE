# LBA E-Blast — 2026-09-21-reception — Mailchimp Package
...
- The opening reception is Monday the 28th
- Long Beach Tech Week opens Monday
- Kick off Long Beach Tech Week with us

Preheader in this template:

> Monday, September 28th. Hear from the city, the SBA and regional CEOs, then stay for the week.

## Load it into Mailchimp

**Content → Email templates → Create Template → Code your own → Import Zip**, upload
`lba-eblast-2026-09-21-reception.zip`, then start a campaign from the saved template. Mailchimp uploads the
