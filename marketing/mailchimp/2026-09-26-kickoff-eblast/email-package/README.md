# LBA E-Blast — 2026-09-26-kickoff — Mailchimp Package
...
- Long Beach Tech Week opens Monday evening
...
> An evening at the new Tech Hub Center, then the Summit on October 1st. Each registers separately.

## Load it into Mailchimp

**Content → Email templates → Create Template → Code your own → Import Zip**, upload
`lba-eblast-2026-09-26-kickoff.zip`, then start a campaign from the saved template. Mailchimp uploads the
