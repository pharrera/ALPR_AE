# LBA E-Blast — 2026-09-15 — Mailchimp Package
...
- Starting this morning: Session 1 with René
- René Redwood is on Zoom at 10 AM
- Today: Purpose, People, and AI

Preheader in this template:

> Session 1 of Building an AI-Ready Trusted Business starts this morning on Zoom, and there is still room.

## Load it into Mailchimp

**Content → Email templates → Create Template → Code your own → Import Zip**, upload
`lba-eblast-2026-09-15.zip`, then start a campaign from the saved template. Mailchimp uploads the
