# LBA E-Blast — 2026-09-26-summit — Mailchimp Package
...
- Meet the four leaders we honor on October 1st
...
`lba-eblast-2026-09-26-summit.zip`, then start a campaign from the saved template. Mailchimp uploads the
